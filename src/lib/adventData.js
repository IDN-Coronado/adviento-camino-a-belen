const data = {
	'2020-12-01': {
		...
		challenge: 'Comparte una tarjeta navideña con una persona. Puedes hacerla o buscar una… acá te dejamos una:',
		gift: {
	...
	'2020-12-03': {
		...
		challenge: 'No olvides esta semana orar por aquellos que necesitan. Te dejamos una lista de oración:',
		gift: {
			href: 'https://drive.google.com/file/d/1eqpyNHbkvuhxpSfgphlloVH4z--WbMAn/view?usp=sharing',
			text: 'Lista de oración',
		}
	},
	'2020-12-04': {
		date: '2020-12-04',
		...
		challenge: 'Es un lindo tiempo para hacer manualidades navideñas en familias. Acá te compartimos un video con algunas:',
		gift: {
