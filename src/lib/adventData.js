const data = {
	...
	'2020-12-05': {
		...
		gift: {
			href: 'https://www.youtube.com/playlist?list=PL--EnK8-SIoyK-LtozjbT2IOrg8jrqIjR',
			text: 'Escúchala acá.',
		}
	},
	'2020-12-06': {
	...
	'2020-12-07': {
		...
		gift: {
			href: 'https://www.youtube.com/watch?v=pmExv6-Y-R8',
			text: 'Mira el video',
		}
	},
	'2020-12-08': {
	...
	'2020-12-10': {
		...
		name: '10 Diciembre',
		verse: {
			text: 'Y, mientras estaban allí, se le cumplió el tiempo. Así que dio a luz a su hijo primogénito. Lo envolvió en pañales y lo acostó en un pesebre, porque no había lugar para ellos en la posada.',
			location: 'Lucas 2:6-7'
		},
	...
	'2020-12-12': {
		...
		name: '12 Diciembre',
		verse: {
			text: 'Hoy les ha nacido en la ciudad de David un Salvador, que es Cristo el Señor.',
			location: 'Lucas 2:11'
		},
	...
	'2020-12-13': {
		...
		name: '13 Diciembre',
		verse: {
			text: 'Y de repente apareció con el ángel una multitud de los ejércitos celestiales, alabando a Dios y diciendo: Gloria a Dios en las alturas, y en la tierra paz entre los hombres en quienes él se complace.',
			location: 'Lucas 2:13-14'
		},
